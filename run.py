...
#     pytest.main(['-s', '-q', r'C:\Users\1\PycharmProjects\feigua-houtai\tools\gettoken.py', '--alluredir',
#                  './report/xml'])
if __name__=='__main__':
    pytest.main(["-s", "--alluredir", "C:/Users/1/PycharmProjects/feigua-houtai/report", "gettoken.py"])
